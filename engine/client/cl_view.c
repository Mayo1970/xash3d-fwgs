...
void V_RenderView( void )
{
	...
	PS3_DIAG_FRAME( "cl: V_RenderView enter, video_prepped=%i", (int)cl.video_prepped );
	...
	PS3_DIAG_FRAME( "cl: V_RenderView after GL_BackendStartFrame" );
	...
	do
	{
		...
		PS3_DIAG_FRAME( "cl: before GL_RenderFrame, viewnum=%i", viewnum );
		GL_RenderFrame( &rvp );
		PS3_DIAG_FRAME( "cl: after GL_RenderFrame, viewnum=%i", viewnum );
		S_UpdateFrame( &rvp );
		viewnum++;
	...
	PS3_DIAG_FRAME( "cl: V_RenderView exit" );
}
