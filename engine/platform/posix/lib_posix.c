...
#include "platform/platform.h"
	...
	#include <vrtld.h>
#elif !defined( XASH_NO_LIBDL )
	#include <dlfcn.h>
#else
// no dlopen-alike available at all (e.g. PS3/PSL1GHT has no dlfcn.h and no
// community ELF loader) -- XASH_NO_LIBDL's dlopen/dlsym/dlclose/dlerror/
// dladdr stubs below stand in for it, but the real <dlfcn.h> types/macros
// they'd normally reuse don't exist either, so provide minimal ones here.
	#define RTLD_NOW 2
	typedef struct
	{
