...
static void SV_PutClientInServer( sv_client_t *cl )
{
	...
	PS3_DIAG( "sv: SV_PutClientInServer enter" );
	...
	else
	{
		...
		PS3_DIAG( "sv: before SV_InitEdict" );
		SV_InitEdict( ent );
		PS3_DIAG( "sv: after SV_InitEdict" );
		...
		PS3_DIAG( "sv: before pfnClientPutInServer" );
		svgame.dllFuncs.pfnClientPutInServer( ent );
		PS3_DIAG( "sv: after pfnClientPutInServer" );
...
PS3_DIAG( "sv: SV_PutClientInServer exit" );
}
