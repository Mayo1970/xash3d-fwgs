...
// PSL1GHT has no dlopen/dlsym at all, so the whole module-loading half of this
// header and of interface.cpp is compiled out on PS3. Only the in-process
// interface registry (CreateInterface/Sys_GetFactoryThis) is reachable there,
// which is all cdll_int.cpp and vgui_parser.cpp actually use.
#if !XASH_PS3
