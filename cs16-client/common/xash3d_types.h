...
// _inline is an MSVC spelling, and this whole arm had never been compiled by
// anything but MSVC: upstream cs16-client has no big-endian target, so the
// only other branch of this #ifdef is the one every LE build takes.
