...
// PS3: PSL1GHT has no dynamic loader and ships no dlfcn.h. HMODULE and
// GetProcAddress are only used by the module-loading half of interface.cpp,
// which is compiled out here for the same reason -- see the comment there.
#include <unistd.h>
