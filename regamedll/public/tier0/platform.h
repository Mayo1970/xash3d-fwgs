...
#elif defined __linux__ || defined __APPLE__ || defined __PPU__
// __PPU__ (PS3): there is no dynamic loader at all, every module is statically
// linked into one ELF, so the export/import decorations are empty exactly as
// they are on the ELF platforms above.
