...
public:
	...
	// the -fno-rtti replacement for dynamic_cast<CBasePlayerItem *>, see the
	// declaration in CBaseEntity (dlls/cbase.h)
	virtual CBasePlayerItem *MyItemPointer() { return this; }
