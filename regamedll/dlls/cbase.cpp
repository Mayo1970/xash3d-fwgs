...
void OnFreeEntPrivateData(edict_t *pEnt)
{
	...
	// was dynamic_cast<CBasePlayerItem *>(pEntity); this module is built
	// -fno-rtti on PS3, see MyItemPointer in dlls/cbase.h
	CBasePlayerItem *pItem = pEntity->MyItemPointer();
	if (pItem)
	{
