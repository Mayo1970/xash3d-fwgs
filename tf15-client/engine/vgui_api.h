...
// TFC-5: this vendored copy was stale vs. the real engine/vgui_api.h --
// the EnableTextInput slot below used to read "void (*Unused)(void)" here,
// same offset, different signature. Patched to match; nothing in this tree
// calls the field by name either way, so this was not a live bug.
