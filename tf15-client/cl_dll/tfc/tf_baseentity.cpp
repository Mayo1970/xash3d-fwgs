...
// player.h's declaration takes a second bCallHolster arg (TFC-2 widened it to
// match dlls/player.cpp's real body); this stub predates that fix upstream.
int CBasePlayer::RemovePlayerItem( CBasePlayerItem *pItem, bool bCallHolster ) { return FALSE; }
