...
#define BS_HAS_ENTRY_TELEPORTER	(1<<5)
#define BS_HAS_EXIT_TELEPORTER	(1<<6)
#define BS_CANB_ENTRY_TELEPORTER	(1<<7)
#define BS_CANB_EXIT_TELEPORTER	(1<<8)
...
extern const char *sTeamSpawnNames[];
extern const char *sClassNames[];
extern const char *sNewClassModelFiles[];
extern const char *sOldClassModelFiles[];
extern const char *sClassModels[];
extern const char *sClassCfgs[];
extern const char *sGrenadeNames[];
...
// TFC-6 Phase 1 -- server-side team/class selection + loadouts (tf_client.cpp)
