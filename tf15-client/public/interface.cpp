...
#if !defined( _WIN32 ) && !defined( __PPU__ )
...
// Sys_GetProcAddress/Sys_LoadModule/Sys_UnloadModule/Sys_GetFactory below all
// need real dlopen/dlsym/dlclose, unavailable on PS3. Only two callers in
// this tree ever use them (CL_LoadParticleMan under USE_PARTICLEMAN,
// CL_LoadMainUI under TF15CLIENT_ADDITIONS, both in cdll_int.cpp) and
// neither macro is defined for this build, so nothing calls into this block
// -- confirmed by grepping the whole cl_dll tree, not assumed.
#if !defined( __PPU__ )
//-----------------------------------------------------------------------------
