...
// No dlopen on PSL1GHT (PS3) -- same reason input_goldsource.cpp's SDL2
// dlopen-based joystick shim is excluded elsewhere in this project. Nothing
// reachable in this build calls Sys_LoadModule/Sys_GetFactory (only the
// TF15CLIENT_ADDITIONS-gated mainui loader and the USE_PARTICLEMAN-gated
// particleman loader do, and neither macro is defined here), so their
// declarations below can stay -- just without a real dlopen/dlsym backing.
#if !defined( __PPU__ )
