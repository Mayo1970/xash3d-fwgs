...
#if XASH_PS3
// drains gl_studio.c's per-frame phase accumulators; see R_DrawEntitiesOnList
...
#if XASH_PS3
extern convar_t	gl_ps3_swizzle;
extern convar_t	gl_ps3_mipmap;
extern convar_t	gl_ps3_dump_dlight;
extern convar_t	gl_ps3_dlight_probe;
#endif
...
#if XASH_PS3
extern convar_t r_studio_fastcolor;
extern convar_t r_studio_hostarrays;
extern convar_t r_studio_fastfill;
#endif
